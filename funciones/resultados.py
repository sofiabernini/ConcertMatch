...
#en este archivo se obtienen los datos para crear los gráficos
#   - obtener_mejores (df, columna_porcentaje = 'porcentaje_coincidencia', top_n=5)
#   - mostrar_info_resultados (df_mejores)
#   - grafico_resultado()
